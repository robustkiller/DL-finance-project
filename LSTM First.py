...
train_data = mid_prices[:2800]
test_data = mid_prices[2800:]
...
for di in range(0,2300,smoothing_window_size):
...
test_points_seq = np.arange(2800,3231,50).tolist()
